...
Khác với những phân phối kể trên, phân phối Poisson không dựa trên chuỗi Bernoulli.

Quá trình Poisson (Poisson process)
...
Phân phối Poisson dùng để đếm **số lượng** biến cố ngẫu nhiên xảy ra trong 1 khoảng thời gian cố định (với điều kiện $\lambda$ không thay đổi trong khoảng thời gian này) của chuỗi Poisson.
