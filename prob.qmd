...
Lý thuyết xác suất ra đời để giải quyết một vụ tranh chấp trong cờ bạc. Vấn đề cụ thể khai sinh ra lĩnh vực này được gọi là "Bài toán Chia điểm" (Problem of Points).
...
Ví dụ: không gian mẫu của tung đồng xu là $\Omega = \text{{sấp, ngửa}}$
...
Ví dụ: không gian mẫu của tung đồng xu là $\Omega = \text{{sấp, ngửa}}$ thì sấp hoặc ngửa là một điểm mẫu.

### Kết quả (outcome)

Là điểm mẫu quan sát được, khi chúng ta cho tiến hành phép thử ngẫu nhiên.
